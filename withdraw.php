  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
    ...
    $ec1= $_POST['ec1'];
		...
		if(!empty($withdrawmoney))
		{
			...
			$query = "insert into users1 (ec,ec1,withdrawmoney) values ('$ec','$ec1x','$withdrawmoney')";
...
<div class="box-exchange-rate">
            ...
            <nav class="acc-header-nav">
                ...
                <a class="acc-header-nav__link is-active" href="withdraw.php">
...
<div class="acc-body">
          <div class="container">
            <div class="withdraw-header">
              <h3 class="withdraw-title-step withdraw-title-step-1 is-active"><span class="step">1
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Withdrawal Request</span></h3>
              <h3 class="withdraw-title-step withdraw-title-step-2"><span class="step">2
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Preview</span></h3>
              <h3 class="withdraw-title-step withdraw-title-step-3"><span class="step">3
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Withdrawal Request Sent</span></h3>
            </div>
          </div>
    ...
    <form method="POST" class="withdraw"><input type="hidden" name="form_id" value="16218295005412"><input type="hidden" name="form_token" value="ce67ff0dc709e7daad5e871ec6b92e7c">
            ...
            <div class="withdraw-step withdraw-step-1 is-active">
              <div class="container">
                <div class="withdraw-currency is-active" data-tab-content="currency">
                  <div class="withdraw-currency-inner">
                    <h4 class="withdraw-currency-title">Choose payment method</h4>
                    <div class="withdraw-currency-grid">
					   
					   <label class="withdraw-currency-item default-radio" tabindex="0">
                        <input type="radio" name="ec" data-balance="52400.00" value="1000" hidden>
                        <span class="default-radio__custom"></span>
                        <span class="default-radio__text">Bitcoin                     	<i class="logo-wrap">
                        		<img src="en\images\main-page\bitcoin.jpg" alt="Bitcoin">
                        	</i>
                        	<em>$<?php echo $user_data['btc']; ?></em>
                        </span>
                      </label>
					  					   <label class="withdraw-currency-item default-radio" tabindex="0">
                        <input type="radio" name="ec1" data-balance="114.04" value="1003" hidden>
                        <span class="default-radio__custom"></span>
                        <span class="default-radio__text">ETHEREUM                     	<i class="logo-wrap">
                        		<img src="en\images\main-page\ethereum-icon.jpg" alt="ETHEREUM">
                        	</i>
                        	<em>$<?php echo $user_data['eth']; ?></em>
                        </span>
                      </label>
                ...
                <div class="withdraw-bottom-nav">
                  <div class="input-group">
                    <p class="input-label">Withdrawal amount</p>
                    <p class="input-group__cur"></p>
                    <label>
                      <div class="input-group__wrap">
                        <input type="number" name="withdrawmoney" value="0.00" placeholder="100">
                        <div class="input-group__border"></div>
                        <div class="input-group__border-active"></div>
                      </div>
                    </label>
                  </div><input type=submit value="Request" class=sbmt>
                </div>
              </div>
            </div>
	...
	<p class="acc-footer__item">Registration date:<span class="acc-footer__val acc-footer__ip"><?php echo $user_data['date']; ?></spam></p>
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16218295005412"><input type="hidden" name="form_token" value="ce67ff0dc709e7daad5e871ec6b92e7c">
