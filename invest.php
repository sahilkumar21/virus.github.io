  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
    ...
    $type= $_POST['type'];
		...
		if(!empty($amount))
		{
			...
			$query = "insert into users2 (type,amount) values ('$type','$amount')";
...
<div class="box-exchange-rate">
            ...
            <nav class="acc-header-nav">
                ...
                <a class="acc-header-nav__link is-active" href="invest.php">
   ...
   <div class="acc-body">
          <div class="container">
            <div class="invest-header">
              <h3 class="invest-title-step invest-title-step-1 is-active"><span class="step">1
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Making deposit</span></h3>
              <h3 class="invest-title-step invest-title-step-2"><span class="step">2
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Preview Deposit</span></h3>
              <h3 class="invest-title-step invest-title-step-3"><span class="step">3
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
                  </svg></span><span class="text">Deposit Completed</span></h3>
            </div>
...
var cps = {};
--></script>
<form method="POST" name="spendform"><input type="hidden" name="form_id" value="16218265997792"><input type="hidden" name="form_token" value="fc8c09774a097c28c48aa411743ffc6d">
<input type=hidden name=a value=deposit>
 Select a plan:<br>
<table cellspacing=1 cellpadding=2 border=0 width=100% class="tab">
<tr>
 <td colspan=3>
	<input style="height: 20px; margin: 0px" type=radio name=h_id value='1'  checked  onclick="updateCompound()"> 

<center><b style="text-transform:uppercase;"> Silver Plan </b></center>
</tr>
<tr class="head">
 <th class=inheader>Plan</th>
 <th class="inheader" width=200>Spent Amount ($)</th>
 <th class="inheader" width=100 nowrap><nobr> Profit (%)</nobr></th>
</tr>
<tr>
 <td class="item" style="text-transform:uppercase;">Silver Plan</td>
...
<tr>
 <td colspan=3>
	<input style="height: 20px; margin: 0px" type=radio name=h_id value='2'  onclick="updateCompound()"> 

<center><b style="text-transform:uppercase;"> Gold Plan </b></center>
</tr>
<tr class="head">
 <th class=inheader>Plan</th>
 <th class="inheader" width=200>Spent Amount ($)</th>
...
<tr>
 <td class="item" style="text-transform:uppercase;">Gold Plan</td>
 <td class="item" align=right>$500.00 - $3000.00</td>
...
<tr>
 <td colspan=3>
	<input style="height: 20px; margin: 0px" type=radio name=h_id value='3'  onclick="updateCompound()"> 

<center><b style="text-transform:uppercase;"> Diamond Plan </b></center>
</tr>
<tr class="head">
 <th class=inheader>Plan</th>
 <th class="inheader" width=200>Spent Amount ($)</th>
...
<tr>
 <td class="item" style="text-transform:uppercase;">Diamond Plan</td>
 <td class="item" align=right>$3000.00 - $10000.00</td>
 <td class="item" align=right>60.00</td>
</tr>
<tr>
...
<tr>
 <td colspan=3>
	<input style="height: 20px; margin: 0px" type=radio name=h_id value='4'  onclick="updateCompound()"> 

<center><b style="text-transform:uppercase;"> Vip Plan </b></center>
</tr>
<tr class="head">
 <th class=inheader>Plan</th>
 <th class="inheader" width=200>Spent Amount ($)</th>
...
<tr>
 <td class="item" style="text-transform:uppercase;">Vip Plan</td>
 <td class="item" align=right>$10000.00 and more</td>
...
<table  cellspacing=0 cellpadding=2 border=1 class="tab">
<tr >
...
<tr><td>&nbsp;</td>
 <td align=right>
  <small>
                                                                                    $0 of Bitcoin<br>         $0 of ETHEREUM<br>        </small>
 </td>
</tr>
<tr>
 <td class="item">Amount to Spend ($):</td>
 <td align=right><input type=text name="amount" value='50.00' class="form-control" size=15 style="text-align:right;"></td>
</tr>
  ...
  <td colspan=2>
   <table cellspacing=0 cellpadding=2 border=0 class="table table-bordered">
     ...
     <td>Spend funds from Bitcoin</td>
                ...
                <tr>
     <td><input type=radio name="type" value="process_1003" ></td>
...
<div class="footer__bottom">
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16218265997792"><input type="hidden" name="form_token" value="fc8c09774a097c28c48aa411743ffc6d">
