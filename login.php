...
<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="user-block__auth">
                <div class="user-block__login" href="login.php">Login</div>
      ...
      <main>
        ...
        <div class="container">
              <ul class="breadcrumbs" aria-label="Breadcrumb" role="navigation">
                    ...
                    <li class="breadcrumbs__item"><span>Login</span>
                    </li>
              </ul>
        </div>
        <section class="signup">
          <div class="container">
            <h2 class="signup__title">Login to Account</h2>
            <p class="signup__text">Securly login to your account.</p>
...
function checkform() {
 ...
 <form class="form-signup" method=post>
                ...
                <div class="input-group">
                  <label>
                    <div class="input-group__wrap">
                      <input type="text" name="user_name" placeholder="Email" data-msg-required="Check for correct input">
              ...
              <div class="form-signup__btns">
                <button class="btn-trans form-signup__btn" type="submit">Login</button>
              </div>
            </form>
        ...
        <div class="footer__top">
          <div class="container">
            <ul class="no-style footer__nav">
              ...
              <li class="footer__nav-item"><a class="footer__nav-link" href="index3898.html?a=cust&amp;page=about">About Us</a></li>
              <li class="footer__nav-item"><a class="footer__nav-link" href="index4f30.html?a=cust&amp;page=a-program">Affiliate Program</a></li>
              <li class="footer__nav-item"><a class="footer__nav-link" href="index38cd.html?a=faq">FAQ</a></li>
              <li class="footer__nav-item"><a class="footer__nav-link" href="index15a0.html?a=support">Contact us</a></li>
            </ul>
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16210860886561"><input type="hidden" name="form_token" value="cb60fd9ba6fc92b3aae5bbcae0f94033">
