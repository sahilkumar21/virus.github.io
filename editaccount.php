...
currentPrice.send();
            ...
            <nav class="acc-header-nav">
                ...
                <a class="acc-header-nav__link is-active" href="editaccount.php">
...
<div class="acc-body">
          <section class="acc-edit js-step-1">
            <div class="container">
...
<form class="acc-edit__form" action="index.php" method=post onsubmit="return checkform()" name=editform><input type="hidden" name="form_id" value="16225433836013"><input type="hidden" name="form_token" value="611194fb1254e637f66aa9638a6fd503">
<input type=hidden name=a value=edit_account>
<input type=hidden name=action value=edit_account>
      
                <div class="acc-edit__main-info">
                  <div class="acc-edit__form-group">
                    <div class="input-group">
                      <label><img src="en/images/icons/ic_profile-trans.svg" alt="Full Name">
                        <div class="input-group__wrap">
                          <input type="text" name=fullname value='jatinrajoriya7'>
                    ...
                    <div class="input-group">
                      <label><img src="en/images/icons/ic_mail-trans.svg" alt="email">
                        <div class="input-group__wrap">
                          <input type="email"  name=email value='jatinrajoriya7@gmail.com' >
                          <div class="input-group__border"></div>
                        </div>
                      </label>
                    </div>
                  ...
                  <div class="acc-edit__form-group">
                    <div class="input-group">
                      <label><img src="en/images/icons/ic_lock-trans.svg" alt="name">
                        <div class="input-group__wrap">
                          <input type="password" name=password value="" placeholder="New password" data-msg-required="Check for correct input">
                          <div class="input-group__border"></div>
                    ...
                    <div class="input-group">
                      <label><img src="en/images/icons/ic_lock-trans.svg" alt="name">
                        <div class="input-group__wrap">
                          <input type="password" name=password2 value=""  placeholder="Retype password" data-msg-required="Check for correct input">
                          <div class="input-group__border"></div>
                          <div class="input-group__border-active"></div>
                        </div>
                      </label>
                ...
                <div class="acc-edit__payment">
				                                      <div class="acc-edit__form-group">
                                      
									                                                                            <div class="input-group">
                      <label>
                        <div class="input-group__img-block">
                          <div class="img-wrapper input-group__img-wrap"><img src="en/images/main-page/bitcoin.jpg" alt="Bitcoin"></div>
                        </div>
                        <div class="input-group__wrap">
                                                    <input type="text" name="pay_account[1000][Wallet address]" value="">
                                                    <div class="input-group__border"></div>
                          <div class="input-group__border-active"></div>
                        </div>
                      </label>
                      ...
                      <label>
                        <div class="input-group__img-block">
                          <div class="img-wrapper input-group__img-wrap"><img src="en/images/main-page/ethereum-icon.jpg" alt="ETHEREUM"></div>
                        </div>
                        <div class="input-group__wrap">
                                                    <input type="text" name="pay_account[1003][Wallet address]" value="0x84F3E804932F35cbD48E3D0373B9a5132c2cCcEd">
                                                    <div class="input-group__border"></div>
                          <div class="input-group__border-active"></div>
                        </div>
                      </label>
                ...
                <div class="acc-edit__btn-block">
                  <button class="btn acc-edit__submit" type="submit">Save changes</button>
                </div>
              </form>
            </div>
          </section>
	...
	<p class="acc-footer__item">Registration date:<span class="acc-footer__val acc-footer__ip"><?php echo $user_data['date']; ?></spam></p>
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16225433836013"><input type="hidden" name="form_token" value="611194fb1254e637f66aa9638a6fd503">
