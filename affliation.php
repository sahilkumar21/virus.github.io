...
currentPrice.send();
          ...
          <nav class="acc-header-nav">
              ...
              <a class="acc-header-nav__link is-active" href="affliation.php">
...
<div class="acc-body">
        <section class="acc-af-header">
          <div class="container">
      <div class="aff-title">
      <span>Your Affiliate Status: <span class="refstatus">STANDARD</span></span>
      </div>

            <div class="acc-af-header__block">
              <div class="acc-af-header__item">
                <p class="acc-af-header__item-title">Total affiliates:</p>
                <p class="acc-af-header__item-text">0</p>
              </div>
              <div class="acc-af-header__item">
                <p class="acc-af-header__item-title">Total active affiliates:</p>
                <p class="acc-af-header__item-text">0</p>
              </div>
              <div class="acc-af-header__item">
                <p class="acc-af-header__item-title">Total affiliates commission:</p>
                <div class="acc-af-header__tab-block" data-show="btc">
                  <div class="g-tab-nav acc-af-header__tabs">
                                <a class="g-tab-nav__item is-active" href="javascript:;">USD</a>
                      <!----
                                          <a class="g-tab-nav__item" href="javascript:;">LTC</a>
                                          <a class="g-tab-nav__item" href="javascript:;">ETH</a>
                                          <a class="g-tab-nav__item" href="javascript:;">XMR</a>
                                          <a class="g-tab-nav__item" href="javascript:;">XRP</a>
                                          <a class="g-tab-nav__item" href="javascript:;">DASH</a>
                      ---->
                                        </div>
                  <div class="acc-af-header__cur-block">
                                <p class="acc-af-header__cur">$0.00</p>
      ...
      <section class="acc-af-banner">
          <div class="container">
            <div class="acc-af-banner__header">
              <h2 class="acc-af-banner__title">Banners</h2>
              <div class="g-tab-nav acc-af-banner__tabs">
                <div class="g-tab-nav__item is-active acc-af-banner__tab" tabindex="1">728x90</div>
                <div class="g-tab-nav__item acc-af-banner__tab" tabindex="2">468x60</div>
                <div class="g-tab-nav__item acc-af-banner__tab" tabindex="3">160x600</div>
                <div class="g-tab-nav__item acc-af-banner__tab" tabindex="4">125x125</div>
              </div>
            </div>
            <div class="acc-af-banner__content">
              <div class="acc-af-banner__item">
                <div class="acc-af-banner__item-wrap">
                  <div class="acc-af-banner__preview acc-af-banner__preview--lg"><img src="http://bitnet-global.ltd/images/728.gif" width="728" height="90" border="0"/></div>
                  <p class="acc-af-banner__preview-html"><code>&lt;a href="http://bitnet-global.ltd/?ref=jatinrajoriya7">&lt;img src="http://bitnet-global.ltd/images/728.gif" width="728" height="90" border="0"/></code></p>
                </div>
              </div>
              <div class="acc-af-banner__item">
                <div class="acc-af-banner__item-wrap">
                  <div class="acc-af-banner__preview acc-af-banner__preview--md"><img src="http://bitnet-global.ltd/images/468.gif" width="468" height="60" border="0"/></div>
                  <p class="acc-af-banner__preview-html"><code>&lt;a href="http://bitnet-global.ltd/?ref=jatinrajoriya7">&lt;img src="http://bitnet-global.ltd/images/468.gif" width="468" height="60" border="0"/></code></p>
                </div>
              </div>
              <div class="acc-af-banner__item">
                <div class="acc-af-banner__item-wrap">
                  <div class="acc-af-banner__preview acc-af-banner__preview--sm"><img src="http://bitnet-global.ltd/images/160.gif" width="160" height="600" border="0"/></div>
                  <p class="acc-af-banner__preview-html"><code>&lt;a href="http://bitnet-global.ltd/?ref=jatinrajoriya7">&lt;img src="http://bitnet-global.ltd/images/160.gif" width="160" height="600" border="0"/></code></p>
                </div>
              </div>
              <div class="acc-af-banner__item">
                <div class="acc-af-banner__item-wrap">
                  <div class="acc-af-banner__preview acc-af-banner__preview--esm"><img src="http://bitnet-global.ltd/images/125.gif" width="125" height="126" border="0"/></div>
                  <p class="acc-af-banner__preview-html"><code>&lt;a href="http://bitnet-global.ltd/?ref=jatinrajoriya7">&lt;img src="http://bitnet-global.ltd/images/125.gif" width="125" height="126" border="0"/></code></p>
                </div>
              </div>
            </div>
          </div>
        </section>
        <section class="acc-af-ref">
          <div class="container">
    
    <!----
            <h2 class="acc-af-ref__title">Your Referrals</h2>
            <table class="striped-table acc-af-ref__table">
              <thead>
                <tr>
                  <td>Username</td>
                  <td>Level</td>
              ...
              <tbody>
                <tr class='js-clone'>
                  <td class="js-login"></td>
                  <td class="js-level"></td>
                  <td class="js-regdate"></td>
    ...
    <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16225431398430"><input type="hidden" name="form_token" value="e81f0d6b92acf71847493b9f88e837e0">
