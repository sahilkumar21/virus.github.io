...
currentPrice.send();
            ...
            <nav class="acc-header-nav">
                ...
                <a class="acc-header-nav__link is-active" href="depositlist.php">
...
<tr>
 <td colspan=3 align=center><b>Silver Plan</b></td>
</tr><tr>
...
<table cellspacing=1 cellpadding=2 border=0 width=100%  class="tab">
<tr>
 <td colspan=4>   <div class="deposits-grid-header">
                	You have no active deposits.&nbsp;<a href="invest.html" style="text-decoration: underline;">Click here</a>&nbsp;to make your investment now.
                </div></td>
</tr>           
</table>
...
<table cellspacing=1 cellpadding=2 border=0 width=100%  class="tab">
<tr>
 <td colspan=3 align=center><b>Gold Plan</b></td>
</tr><tr>
 <th class=inheader>Plan</th>
 <th class=inheader width=200>Amount Spent ($)</th>
 <th class=inheader width=100 nowrap><nobr> Profit (%)</nobr></th>
...
<table cellspacing=1 cellpadding=2 border=0 width=100%  class="tab">
<tr>
 <td colspan=3 align=center><b>Diamond Plan</b></td>
</tr><tr>
 <th class=inheader>Plan</th>
 <th class=inheader width=200>Amount Spent ($)</th>
 <th class=inheader width=100 nowrap><nobr> Profit (%)</nobr></th>
...
<table cellspacing=1 cellpadding=2 border=0 width=100%  class="tab">
<tr>
 <td colspan=3 align=center><b>Vip Plan</b></td>
</tr><tr>
 <th class=inheader>Plan</th>
 <th class=inheader width=200>Amount Spent ($)</th>
 <th class=inheader width=100 nowrap><nobr> Profit (%)</nobr></th>
	...
	<p class="acc-footer__item">Registration date:<span class="acc-footer__val acc-footer__ip"><?php echo $user_data['date']; ?></spam></p>
      ...
      <div class="default-modal modal-login">
        <div class="default-modal__content">
		  ...
		  <form class="formLogin" method=post name=mainform onsubmit="return checkform()"><input type="hidden" name="form_id" value="16225423578181"><input type="hidden" name="form_token" value="5e6efe18571af512613cc90b1d9e94ff">
